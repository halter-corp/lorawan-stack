...
func TestComponentPrefixKEKLabeler(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		Addr          string
		Func          func(context.Context, cryptoutil.ComponentPrefixKEKLabeler, string) string
		Expected      string
	}{
		{
			Addr: "",
			Func: func(ctx context.Context, labeler cryptoutil.ComponentPrefixKEKLabeler, addr string) string {
		...
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			t.Parallel()
			a := assertions.New(t)
			labeler := cryptoutil.ComponentPrefixKEKLabeler{
